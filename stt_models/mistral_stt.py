"""
Adaptateur STT pour l'API Mistral AI Voxtral Transcribe.
"""
...
class MistralSTT(STTModel):
    """Adaptateur STT pour l'API Mistral AI (Voxtral Transcribe)."""

    name = "mistral"
    description = "Mistral AI Voxtral Transcribe API"
    tier = "api"
    ...
    def is_available(self) -> bool:
        """Vérifie que la clé Mistral est configurée."""
        try:
    ...
    def transcribe(self, audio_path: str) -> TranscriptionResult:
        """Transcrit le fichier audio via l'API Mistral."""
        ...
        try:
            ...
            logger.exception("Erreur pendant la transcription Mistral")
            latency = time.perf_counter() - t_start
